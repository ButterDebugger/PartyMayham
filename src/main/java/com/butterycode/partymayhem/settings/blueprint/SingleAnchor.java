...
public non-sealed class SingleAnchor implements Blue {
    ...
    public SingleAnchor(@NotNull MinigameFactory minigame, @NotNull String id, @NotNull Component displayName) {
